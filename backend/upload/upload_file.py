"""
Upload routes – receive files, extract text, persist metadata.
"""
...
from .file_processor import extract_text, save_raw_text
...
async def upload_file(
    ...
    """
    Upload a PDF or image file for text extraction.
    ...
    subject  : optional free-text subject name
    """
    # ── validate inputs ──────────────────────────────────────────────────
    ...
    # ── save extracted text ──────────────────────────────────────────────
    type_text_dir = os.path.join(RAW_TEXT_DIR, doc_type)
